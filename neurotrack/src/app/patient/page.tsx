...
import PatientHomePage from "@/components/app/patienthomepage";

// ✅ Define sidebar items
const navItems = [
{ value: "home", label: "Home", icon: Bot, component: <PatientHomePage/> },
  { value: "reminders", label: "Reminders", icon: Bot, component: <PatientReminders /> },
